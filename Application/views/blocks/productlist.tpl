...
[{/if}]
<script>var gw_oxid_infinitescrolling_scrollpagesamount = [{$config->getConfigParam('gw_oxid_infinitescrolling_scrollpagesamount')|intval}];var gw_oxid_infinitescrolling_base_url = '[{$oViewConf->getHomeLink()}]';</script>